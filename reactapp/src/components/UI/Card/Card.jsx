...
const Card = ({ question, correctAnswerMarkUpdate, attempt, options, answer, setQsns, qsn, setCard, qsnAttempt }) => {
    ...
    // State variable to track the marked status of the buttonconst [marked, setMarked] = useState(false);
    // Event handler to handle the click event on the optionsconst click = (clicked) => {
